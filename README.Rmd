...
Explorar cambios a traves del tiempo en una perspectiva de periodo. Vamos a usar un model que no asume estabilidad de tasas demograficas. 
...
Ahora podemos graficar cambio a travel del tiempo, por ejemplo, en el numero promedio de abuelos para ninos de 5 anios de edad:
...
Finalmente, que tan comun es perder a un abuelo y a que edad se experimenta la perdida de un abuelo en los distintos paises? Como ha cambiado esto a traves del tiempo?
