---
title: "Laboratorio del taller 'Demografía del parentesco: introducción a temas y métodos'"
...
Explorar cambios a traves del tiempo en una perspectiva de periodo. En este ejemplo, vamos a usar un modelo que no asume estabilidad de tasas demograficas. Los modelos "dinámicos" (es decir, no estables) tardan más tiempo en correr. 
